...
import {
  ...
  CloudDownload, Globe, FileText, Wrench, Settings, Languages, Factory, Box, MapPin, Plus, LogOut, Users, BrainCircuit, BatteryCharging
} from "lucide-react";
...
export default function Navbar() {
  ...
  const navItems = [
    ...
    { name: t.power, href: "/power", icon: BatteryCharging },
